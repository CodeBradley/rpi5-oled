...
from rpi5_oled.config import config, load_config, configure_logging
from rpi5_oled.display import OLEDDisplay
from rpi5_oled.layout.containers import (
    MetricContainer, ServiceIconContainer, TextContainer, DividerContainer
)
from rpi5_oled.providers.system import get_metric_provider
from rpi5_oled.providers.services import get_service_provider
from rpi5_oled.providers.network import get_network_info_provider
from rpi5_oled.fonts.icons import get_icon_code
from rpi5_oled.utils.hardware import verify_hardware_requirements
...
def main():
    ...
    try:
        ...
        if args.check_only:
            from rpi5_oled.utils.hardware import check_oled_display
            display_config = config.get_display_config()
